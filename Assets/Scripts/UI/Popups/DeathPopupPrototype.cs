...
namespace ProjectS.UI
{
    ...
    /// <b>2026-08-05에 아래 규칙을 전부 정식 팝업으로 이관했으므로, 이 클래스는 이제 참고용이며 지워도 됩니다</b>
    /// (씬은 'Tools ▸ ProjectS ▸ 사망 팝업 → 정식(DeathPopup)으로 전환'으로 옮깁니다).
    /// 정식 쪽은 여기에 더해 <b>부활도 대기 시간을 거치고</b>, 마을 복귀 전에 <c>Player.Revive()</c>를 불러
    /// HP 0인 채로 마을에 도착하는 것을 막습니다(이 시안에는 빠져 있는 처리입니다).
    /// </summary>
    /// <remarks>
    /// <para>
