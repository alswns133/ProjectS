...
namespace ProjectS.UI
{
    ...
    public interface IPartySource
    {
        ...
        /// <summary>
        /// 도는 카운트다운을 멈춰 출발을 취소한다. <b>파티장·파티원 모두</b> 부를 수 있으며 <b>파티는 유지된다</b>.
        /// </summary>
        /// <remarks>
        /// 파티원 쪽은 출발 응답 팝업의 [취소]가 부른다(2026-09-17 기획 확정 — 갈 생각 없는 파티원 때문에
        /// 파티장이 30초를 그대로 기다리지 않게). 구현체는 파티장 전용으로 거르면 안 된다.
        /// </remarks>
        void CancelDepart();
