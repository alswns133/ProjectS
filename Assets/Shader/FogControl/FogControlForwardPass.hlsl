...
)
{
    ...
    // FOG CONTROL: 원본은 color.rgb = MixFog(color.rgb, inputData.fogCoord); 였습니다.
    color.rgb = MixFogStrength(color.rgb, inputData.fogCoord);
...
#endif // PROJECTS_FOG_CONTROL_FORWARD_PASS_INCLUDED
